...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://10.250.62.200:3306/yttps_skf?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull";
    ...
    private static final String AUTHOR = "Wang";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date
    //数据库的Tables需要在这里添加，自动生成Springboot的整套逻辑（基本增删改查）

    private static String[] TABLES = {
          "shuttle_bus","shuttle_bus_appointments","shuttle_bus_info","shuttle_bus_staff"
    };
